...
If that was too confusing for you, there’s also a offical [guide](https://archipelago.gg/tutorial/Archipelago/setup_en) and multiple videos. Just remember that you will have to run the APWorld to use this mod.

Also, you don't have to host if somebody else is hosting. They will likely tell you to do, then give you the URL so you can connect.
## Progression (wip)
